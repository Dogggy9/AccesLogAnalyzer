...
public class App {
    ...
    private static String path = "D:\\Java\\AccesLogAnalyzer\\access.log";
    private static String outputPath = "D:\\Java\\AccesLogAnalyzer\\result.json";
    ...
    public static void main(String[] args) throws IOException {
        ...
        double averageRequestsPerSecond =(requestsCount / (maxTime - minTime));
